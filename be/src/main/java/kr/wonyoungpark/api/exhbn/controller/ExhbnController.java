...
public class ExhbnController{
    ...
    @PutMapping("/{id}}")
    public ResponseEntity<Long> update(@RequestBody Exhbn t, @PathVariable long id) {
        logger.info("수정 정보: "+t.toString());
        Exhbn e = service.findByExhbnNum(id);
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Long> delete(@RequestBody Exhbn t, @PathVariable long id) {
