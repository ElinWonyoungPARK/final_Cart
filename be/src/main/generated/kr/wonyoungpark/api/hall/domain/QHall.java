...
public class QHall extends EntityPathBase<Hall> {
    ...
    private static final long serialVersionUID = 1156789789L;

    public static final QHall hall = new QHall("hall");

    public final ListPath<kr.wonyoungpark.api.exhbn.domain.Exhbn, kr.wonyoungpark.api.exhbn.domain.QExhbn> exhbnList = this.<kr.wonyoungpark.api.exhbn.domain.Exhbn, kr.wonyoungpark.api.exhbn.domain.QExhbn>createList("exhbnList", kr.wonyoungpark.api.exhbn.domain.Exhbn.class, kr.wonyoungpark.api.exhbn.domain.QExhbn.class, PathInits.DIRECT2);
